...
export class SidebarComponent implements OnInit, OnDestroy {
    ...
    constructor(public menu: MenuService, public settings: SettingsService, public injector: Injector,public dataService:DataService) {
    ...
    ngOnInit() {
        this.dataService.loginData.subscribe(data => {
            if(data)
            {
                console.log("Data is ",data,"where menu is "+this.menuItems);
                this.menuItems.forEach(element => {
                   if(data["permissions"].routePermissions[element["data"]])
                   {
